...
--
-- Host: 127.0.0.1    Database: supermerkatua
-- ------------------------------------------------------
...
CREATE TABLE `tiketa` (
  `id_tiketa` int NOT NULL AUTO_INCREMENT,
  `id_produktua` int DEFAULT NULL,
  `id_saltzailea` int DEFAULT NULL,
  `fetxa` datetime DEFAULT CURRENT_TIMESTAMP,
  `kantitatea_kg` decimal(20,3) DEFAULT NULL,
  `prezioa_guztira` decimal(20,3) DEFAULT NULL,
...
-- Dump completed on 2026-01-23  8:19:13
